...
<template>
  <footer class="footer">
    <!-- Section 1: Search Items -->
    <section class="footer__search">
      <h2 class="footer__search-title">People are also looking for</h2>

      <ul class="footer__search-list">
        <li
          v-for="item in footerSearchItems"
          :key="item"
          class="footer__search-item"
        >
          {{ item }}
        </li>
      </ul>
    ...
    <section class="footer__main">
      ...
      <div class="footer__brand">
        <NuxtLink to="/" class="footer__logo">
          <img src="/images/logo.png" alt="FoodMart Grocery Store" />
        </NuxtLink>
      ...
      <div class="footer__subscribe">
        <h3 class="footer__heading">Subscribe Us</h3>
    ...
    <section class="footer__bottom">
      <p class="footer__copyright">© 2023 Foodmart. All rights reserved.</p>
    </section>
  </footer>
</template>
